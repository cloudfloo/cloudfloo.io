            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                >
                  <Card className="glass border-gray-700">
                    <CardHeader>
                      <CardTitle className="text-lg text-white">Core Expertise</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                >
                  <Card className="glass border-gray-700">
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        <h4 className="text-sm font-semibold text-gray-400 mb-2">Primary</h4>
                        <div className="flex flex-wrap gap-2">
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-gray-400 mb-2">Secondary</h4>
                        <div className="flex flex-wrap gap-2">
              ...
              <Card className="glass border-gray-700">
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold text-white mb-4">
                    Interested in working with {person.name.split(' ')[0]} and the CloudFloo team?
                  </h3>
