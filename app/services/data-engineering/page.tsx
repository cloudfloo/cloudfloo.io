...
import { ArrowLeft, Database, BarChart3, Zap, Shield, Globe, TrendingUp } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';

export const metadata: Metadata = {
  title: 'Data Engineering - CloudFloo.io',
  description: 'Comprehensive data engineering solutions including data pipelines, analytics platforms, and real-time processing.',
};
